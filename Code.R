...
# 2.1 Working with chdage dataset: use glm, get results 
...
# 2.3.1 Using jags and dnorm() priors on alpha and beta and should get values close to the glm
# ***************** Bayesian Inference *******************
num.chains   <- 3
adapt.length <- 1000
burnin       <- 1000
...
# 2.3.2 use jags and dcauchy(); use parameters for the Cauchy described in Seaman et al.
...
# 2.3.3 Use Christensen et al method on the CHD data.
...
# 2.3.4 Use the normal(0,pi^2/(3*(p+1))) prior
#------------------- pi Prior Case ---------------------
p       <- 1
...
# 3.2 induced priors for christensen et al.
sd1 = 1
sd2 = 1
sd3 = 1
sd4 = 1
...
# 3.3.4 N(0, S2/b) Christensen et al.
...
# 3.1 Create list for the estimation of MLE

y <- as.vector(t(normal.matrix))

par(mfrow =c(2,2))
# 3.2.1 Create list for the estimation of normal priors
...
# 3.2.2 Create list for the estimation of normal priors in Christensen methods
...
# 3.2.3 Create list for the estimation of normal priors in pi method
...
# 3.2.4 Create list for the estimation of normal priors in Cauchy method
